export function TreeNav(options)
{
...
TreeNav.prototype = {
    ...
    toggleBranch: function (branch) {
        ...
        if (expanded) {
            this.closeBranchRecursively(branch, true);
        } else {
            this.openBranch(branch, true);
        }
    },
    openBranch: function (branch, animate) {
        ...
        if (animate) {
            children.hide().slideDown(this.animateSpeed);
        }
    },
    closeBranch: function (branch, animate, oncomplete) {
        ...
        if (animate) {
            children.slideUp(this.animateSpeed, hide);
        } else {
            hide();
        }
    },
