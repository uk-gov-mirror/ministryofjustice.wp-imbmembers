...
gulp.task('styles', gulp.series(['wiredep'], function (done) {
    var merged = merge();
...
gulp.task('clean', require('del').bind(null, [path.dist]), function (done) {
    done();
});
...
gulp.task('build', gulp.series(['styles', 'scripts', 'fonts', 'images'], function (done) {
    done();
}));
